...
I learned how to structure the React tree, pass props, handle events and set state. I know setting state should always be done immutably. I used Material-UI for some of my components and built the others myself. 
...
Edit to add: this app now runs in a three-container cluster with Docker. Clone this repo along with the tictactoe-backend one. 
